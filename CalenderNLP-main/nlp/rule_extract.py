...
def extract_rule_based(tokens):
    ...
    # =====================================
    start_pattern = r"(?:lúc|vào lúc)\s+(?P<start_time>\d{1,2}(?:\s*[:hgiờ]\s*\d{1,2}?|\s*rưỡi|\s*[hgiờ])?)"
    ...
    # =====================================
    # Sử dụng lại regex đã cải tiến từ ner_extract.py để đảm bảo tính nhất quán
    # Ví dụ: "ở phòng A, lúc 5h" hoặc "ở phòng A vào thứ 3"
    ...
    # =====================================
    relative_regex = (
        r"(?:vào\s+)?(sáng mai|chiều mai|tối mai|mai|ngày mai|"
        ...
        r"tuần trước nữa|tuần trước|tuần rồi|" # Các ngày trong tuần (đầy đủ và viết tắt)
        r"thứ hai|thứ ba|thứ tư|thứ năm|thứ sáu|thứ bảy|chủ nhật|cn)"
    )
